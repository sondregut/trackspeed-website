...
const campaigns: EmailCampaign[] = [
  ...
  {
    id: "checkin_day14",
    name: "Check-in Day 14",
    trigger: "After convert, non-Pro users only",
    timing: "14 days",
    templateKey: "checkin_day14",
  },
  {
    id: "first_session",
    name: "First Session Summary",
    trigger: "After first session",
    timing: "After first session",
    templateKey: "first_session",
  },
  {
    id: "convert_day7",
    name: "Convert Day 7",
    trigger: "After tips (non-Pro users only)",
    timing: "7 days",
    templateKey: "convert_day7",
  },
  {
    id: "trial_cancelled",
    name: "Cancelled Trial Access",
    trigger: "Cancelled trial only",
