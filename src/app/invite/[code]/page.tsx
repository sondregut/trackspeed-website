...
const PLAY_STORE_URL = 'https://play.google.com/store/apps/details?id=com.trackspeed.android'
      ...
      <div className="bg-white rounded-3xl shadow-sm p-8 w-full max-w-md">
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <span className="text-[#1D1D1F] font-medium">Download for iOS</span>
          </a>
          <a
            href={PLAY_STORE_URL}
            className="flex items-center justify-center gap-3 w-full py-4 px-6 rounded-full border border-[#E5E5E7] hover:bg-[#F5F5F7] transition-colors"
          >
            ...
            <span className="text-[#1D1D1F] font-medium">Download for Android</span>
          </a>
        </div>
