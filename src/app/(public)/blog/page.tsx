      ...
      <section className="pt-32 pb-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg" style={{ color: "var(--text-muted)" }}>
            Guides, comparisons, and training tips to help you get faster with accurate timing.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="card-feature rounded-xl p-8 md:p-12">
            <h2
              ...
              style={{ color: "var(--text-primary)" }}
            >
              Ready to time your sprints?
            </h2>
            <p className="text-body mb-6">
              Download TrackSpeed and start getting accurate, consistent timing data from your iPhone.
            </p>
            <a
