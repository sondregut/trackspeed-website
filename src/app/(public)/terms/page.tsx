      ...
      <div className="max-w-3xl mx-auto prose prose-invert prose-zinc">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-[#9B9A97] space-y-2">
            <li><strong className="text-white">Billing:</strong> Subscriptions are billed through your Apple ID account. Payment will be charged upon confirmation of purchase.</li>
            ...
            <li><strong className="text-white">Cancellation:</strong> You may manage and cancel subscriptions through your Apple ID account settings. Cancellation takes effect at the end of the current billing period.</li>
            <li><strong className="text-white">Price Changes:</strong> We reserve the right to change subscription prices. You will be notified of any price changes in advance.</li>
          </ul>
        </section>
