...
export default async function SprintTimingSystemsComparedPage({params}: {params: Promise<{locale: string}>}) {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Sprint Timing Systems Compared: Laser Gates vs Camera vs Stopwatch" },
    ],
  };
    ...
    <div className="bg-hero min-h-screen">
      ...
      <article className="pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <RelatedPosts currentSlug="sprint-timing-systems-compared" t={(key) => t(key)} tHas={(key) => t.has(key)} locale={locale} />
        </div>
      </article>
    </div>
  );
