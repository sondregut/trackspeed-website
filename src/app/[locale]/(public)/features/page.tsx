...
export default async function FeaturesPage({params}:{params:Promise<{locale:string}>}) {
 ...
 return <div lang="en" dir="ltr" className="pb-20 pt-28 sm:pt-36">
  <section className="px-5 pb-12 sm:px-8"><div className="marketing-container"><Eyebrow>Meet your training toolkit</Eyebrow><h1 className="max-w-4xl text-[clamp(2.75rem,5.5vw,4.5rem)] font-medium leading-[1.05] tracking-[-0.06em]">Every feature.<br/><span className="text-[var(--brand)]">One clear guide.</span></h1><div className="mt-7 grid gap-6 lg:grid-cols-[1fr_auto]"><p className="max-w-2xl text-lg leading-8 text-muted">From your first flying sprint to a full team session. Explore the tools for timing, reviewing and sharing your training.</p><TextLink href="/#how-it-works">Find the right setup</TextLink></div>{locale!=="en"&&<p lang={locale} dir={locale==="ar"?"rtl":"ltr"} className="mt-6 border-s-2 border-[var(--brand)] ps-4 text-sm text-muted">{t("guideLanguage")}</p>}</div></section>
